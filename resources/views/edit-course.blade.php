            ...
            <div class="col-md-12">
                <div class="card card-table">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ url('courses') }}" class="btn btn-default btnwhite">Back To Course</a>
                    </div>
                    <div class="card-body">
                        <div class="padBox">
                            ...
                            <form method="POST" action="" id="editUserForm" enctype="multipart/form-data"> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description" type="text" value="">{{ $course->description }}</textarea>
                                        </div>
                                    </div>
                                                  <div class="col-lg-6">
                                    <div class="form-group">
                                    <label for="Country">Select Author</label>
                                        <select class="form-control" name="author" data-toggle="select2">
                                        <option value="">Select Author</option>
                                               @foreach($authors as $authh)
                                              
                                              <option {{$authh->id == $course->author_id ? 'selected' : ''}} value="{{$authh->id}}">{{$authh->name}}</option>
                                    ...
                                    <label for="Country">Select Category</label>
                                        ...
                                        <option value="">Select Category</option>
                                              ...
                                              <option {{$con->id == $course->category_id ? 'selected' : ''}} value="{{$con->id}}">{{$con->name}}</option>
                                  ...
                                  <div class="col-lg-12">
                                    ...
                                    <label for="Country">Upload Video</label>
                                      <input name="videofile" onchange="readURL(this)" class="form-control" type="file" value="">
                                </div>
                                </div>
                                 @if(!empty($course->video))
                                 <div class="user-image ">

                                <video style="height: 200px !important;" class="img-thumbnail" src="{{ url('/public/assets/image/course')}}/{{$course->video}}" id="profile_img_id" controls></video>
                                ...
                                @if(!empty($course->thumbnail_image))
                                   <div class="user-image ">
                                     <img class="img-thumbnail" src="{{ url('/public/assets/image/course')}}/{{ $course->thumbnail_image  == '' ? 'default-profile-img.png' : $course->thumbnail_image}}" id="profile_img_id1">
                ...
                success: function(data) {
                    ...
                    if (data.code == 200) {
                        ...
                        swal("", data.message, "success", {
                         ...
                         window.location.href = _baseURL+'/courses';
                    } else {
                        var errMsgs = '';
