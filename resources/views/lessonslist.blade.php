            ...
            <div class="col-md-12">
                <div class="card card-table">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ url('add-lesson') }}" class="btn btn-default btnwhite">Add Lesson</a>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-hover table-center mb-0 datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $lsn->title == '' ? '-NA-' :  $lsn->title }}</td>
                                        <td>{{ Str::limit($lsn->description, 20, ' ...') }}</td>
                                        <td>
                                            <!--<a href="{{ url('view-user') }}/{{ $lsn->id }}" class="btn btn-sm bg-info-light">-->
                                            <!--    <i class="far fa-eye mr-1"></i>-->
                                            <!--</a>-->
                                            <a href="{{ url('edit-lesson') }}/{{ $lsn->id }}" class="btn btn-sm bg-success-light">
                                    ...
                                    @else
                                    <tr>
                                        <td colspan="5" style="text-align:center;">No Lessons Found.</td>
                                    </tr>
                                    @endif
...
<input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <p>Are you sure you want to delete this lesson? This process cannot be undone</p>
                <div>
