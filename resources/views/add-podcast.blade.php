                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group"> 
                                            ...
                                            <input name="artist" class="form-control" type="text" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="pickup_time">Album Name</label>
                                  ...
                                  <div class="col-lg-12">
                                    ...
                                    <label for="Country">Upload Audio</label>
                                        <input class="form-control" type="file" id="user-img1" name="audio" value="" >
                                </div>
                                </div>
                                </div>    
...
<script>
    ...
    $("#addCommunityForm").validate({
        ...
        messages: {
            ...
            image: "Please upload cover image",
