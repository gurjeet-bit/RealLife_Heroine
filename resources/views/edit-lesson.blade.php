                    ...
                    <div class="card-body">
                        <div class="padBox">
                            ...
                            <form method="POST" action="" id="editUserForm" enctype="multipart/form-data"> 
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Tilte</label>
                                            <input name="title" class="form-control" type="text" value="{{ $lesson->title }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Description</label>
                                            <textarea class="form-control" name="description" type="text" value="">{{ $lesson->description }}</textarea>
                                        </div>
                                    </div>
                                                  <div class="col-lg-6">
                                    <div class="form-group">
                                    <label for="Country">Select Module</label>
                                        ...
                                        <option value="">Select Module</option>
                                              ...
                                              <option {{$authh->id == $lesson->module_id ? 'selected' : ''}} value="{{$authh->id}}">{{$authh->name}}</option>
                                    ...
                                    <label for="Country">Select Course</label>
                                        ...
                                        <option value="">Select Course</option>
                                              ...
                                              <option {{$con->id == $lesson->course_id ? 'selected' : ''}} value="{{$con->id}}">{{$con->title}}</option>
                                ...
                                <video style="height: 200px !important;" class="img-thumbnail" src="{{ url('/public/assets/image/lesson')}}/{{$lesson->video}}" id="profile_img_id" controls></video>
