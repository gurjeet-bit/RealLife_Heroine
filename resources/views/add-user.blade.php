        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card card-table">
                    ...
                    <div class="card-body">
                        <div class="padBox">
                            <form method="POST"action="{{ url('/insertuser') }}" id="addUserForm">
                                        @csrf
                            <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="card-body text-center">
                                                <div class="user-image ">
                                                    ...
                                                    <img class="rounded-circle img-thumbnail" src="{{ url('/public/profile')}}/default-profile-img.png" id="profile_img_id">
                                  ...
                                  <div class="col-lg-6">
                                    ...
                                    <label for="Country">Path</label>
                                        ...
                                        <option value="">Select Path</option>
                                         <option value="0">Gentle Path</option>
                                         <option value="1">Hilly Path</option>
                                         <option value="2">Mountaineous Path</option>
