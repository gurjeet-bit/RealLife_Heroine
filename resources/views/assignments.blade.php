            ...
            <div class="col-md-12">
                <div class="card card-table">
                    <div class="card-header d-flex justify-content-between align-items-center">
                       ...
                       <a href="{{ url('add-assignment') }}" class="btn btn-default btnwhite">Add Assignment</a> 
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover table-center mb-0 datatable">
                                ...
                                <tbody>
                                    ...
                                    @foreach($assignments as $comm)
                                    <tr>
                                        <td>{{ $loop->iteration }}</td>
                                        <td>{{ $comm->title == '' ? '-NA-' :  $comm->title }}</td>
                                         <td>  
                                        <!--  <a href="{{ url('edit-assignment') }}/{{ $comm->id }}" class="btn btn-sm bg-success-light">
                                                <i class="far fa-edit mr-1"></i>
                                            </a> -->
                                            <!--  <a href="{{ url('edit-assignment') }}/{{ $comm->id }}" class="btn btn-sm bg-info-light">
...
<input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <p>Are you sure you want to delete this assignment? This process cannot be undone</p>
                <div>
