            ...
            <div class="col-md-12">
                <div class="card card-table">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ url('add-user') }}" class="btn btn-default btnwhite">Add User</a>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-hover table-center mb-0 datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{url('user-completed-courses')}}/{{$user->id}}"  class="btn btn-sm bg-success-light">
                                        ...
                                        <td>
                                            ...
                                            <!--    <i class="far fa-eye mr-1"></i>-->
                                            <!--</a>-->
                                            <a href="{{ url('edit-user') }}/{{ $user->id }}" class="btn btn-sm bg-success-light">
                                                <i class="far fa-edit mr-1"></i>
                                            </a>
                                            <a href="javascript: void(0)" onclick="checkId('{{ $user->id }}')" data-toggle="modal" data-target="#deletemodaluser" class="btn btn-sm bg-danger-light delete_review_comment">
        ...
        <div class="modal-content">
            <div class="modal-body">
              ...
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <p>Are you sure you want to delete this user? This process cannot be undone</p>
                <div>
